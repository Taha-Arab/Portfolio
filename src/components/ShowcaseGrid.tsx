      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {items.map((item) => (
          <button
            ...
            className={`group flex flex-col text-left rounded-xl border border-neutral-800 bg-neutral-950 hover:border-neutral-600 transition-colors overflow-hidden ${
              item.kind === "experience" ? "md:col-span-2" : ""
            }`}
          >
            <div className="flex items-center justify-between gap-4 border-b border-neutral-800 p-6 md:p-8">
              <div>
                <div className="text-4xl md:text-5xl font-semibold tracking-tight text-neutral-50">
                  {item.metric}
                </div>
